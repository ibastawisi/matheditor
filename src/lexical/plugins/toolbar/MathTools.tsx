...
export default function MathTools({ editor, value, sx }: { editor: LexicalEditor, value: string, sx?: SxProps<Theme> | undefined }): JSX.Element {
  return (<ToggleButtonGroup size="small" sx={{ ...sx }} >
    <ToggleButton value="wolfram" onClick={() => window.open(`https://www.wolframalpha.com/input?i=${encodeURIComponent(value)}`)}>
      <WolframIcon />
    </ToggleButton>
  </ToggleButtonGroup>)
}