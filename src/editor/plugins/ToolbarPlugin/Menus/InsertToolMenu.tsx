...
import { IconButton, Menu, MenuItem, ListItemIcon, ListItemText, Typography, SvgIcon, Table } from '@mui/material';
import { Add, HorizontalRule, InsertPageBreak, Functions, Brush, StickyNote2, Image, TableChart } from '@mui/icons-material';
